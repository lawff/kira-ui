...
import type { DefaultProps, Selectors } from '@kira-ui/styles'
import { useKiraDefaultProps, useKiraTheme } from '@kira-ui/styles'
import { Box } from '../Box'
...
export const ScrollArea = forwardRef<HTMLDivElement, ScrollAreaProps>(
  (props: ScrollAreaProps, ref) => {
    const {
      ...
      ...others
    } = useKiraDefaultProps('ScrollArea', defaultProps, props)
...
ScrollArea.displayName = '@kira-ui/core/ScrollArea'
