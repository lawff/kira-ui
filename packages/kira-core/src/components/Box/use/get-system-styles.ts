import type { CSSObject, KiraStyleSystemProps, KiraTheme } from '@kira-ui/styles'
...
function getSizeValue(margin: any, theme: KiraTheme) {
...
export function getSystemStyles(systemStyles: KiraStyleSystemProps, theme: KiraTheme) {
